  ...
  return (
    <div>
      <footer className="footer footer-center p-10 bg-gray-600 text-base-content rounded">
        ...
        <div>
          <div className="grid grid-flow-col gap-4 text-white">
           <Link  href="https://www.facebook.com/hasibulcse" target="blank">
              <svg
        ...
        <div>
          <p className="text-white font-bold">
            ...
            <Link className="text-cyan-300 underline" target="_blank" href="https://hasibul-islam365.netlify.app/"> Hasibul Islam</Link>
          </p>
        </div>
      </footer>
    </div>
